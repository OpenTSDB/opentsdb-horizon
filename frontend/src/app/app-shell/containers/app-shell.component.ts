...
export class AppShellComponent implements OnInit, OnChanges, OnDestroy {
    ...
    @ViewChild(NavigatorSidenavComponent, { static: true })
    private sideNav: NavigatorSidenavComponent;
    ...
    constructor(
        ...
        this.store
            ...
            .subscribe(() => {
                ...
                const initialized = this.store.selectSnapshot(
                    DbfsState.getInitialized,
                );
                if (!initialized) {
                ...
                if (urlPath && urlPath.length > 0) {
                    ...
                    if (this.routedApp !== app) {
                        ...
                        if (
                            ...
                            const stateSnapshot: any = this.store.snapshot();
    ...
    ngOnInit() {
        ...
        this.subscription.add(
            this.mediaQuery$.subscribe((currentMediaQuery) => {
                ...
                this.store.dispatch(
                    new SetSideNavOpen(currentMediaQuery !== 'xs'),
                );
            }),
        );
        ...
        this.subscription.add(
            this.sideNavOpen$.subscribe((isOpen) => {
        ...
        this.subscription.add(
            this.resourcesLoaded$.subscribe((resourcesLoaded) => {
                if (resourcesLoaded) {
                    ...
                    this.isAdminMember =
                        user.memberNamespaces.includes('admin');
                }
            }),
        );
    }
        ...
        if (changes.fullUrlPath && changes.fullUrlPath.currentValue) {
            ...
            if (this.firstLoad) {
                ...
                this.store.dispatch(
                    new UpdateNavigatorSideNav({
                        mode: this.drawerMode,
                        currentApp: this.activeNavSection,
                    }),
                );
    ...
    // TODO: cleanup? is it being used?
    drawerClosedStart() { /* empty */ }
