...
export class UtilsService {
    ...
    getColors() {
        const defaultColors =  [
            ...
            '#800080',    //  'purple'
            '#800000',    // 'maroon'
            '#0BC582', '#9E8317', '#01190F', '#847D81', '#58018B', '#B70639', '#703B01', '#118B8A', '#4AFEFA', '#FCB164', '#796EE6', '#000D2C', '#53495F', '#F95475', '#61FC03', '#5D9608', '#98A088', '#4F584E', '#248AD0', '#5C5300', '#9F6551', '#932C70', '#2B1B04', '#B5AFC4', '#D4C67A', '#AE7AA1', '#C2A393', '#0232FD', '#6A3A35', '#BA6801', '#168E5C', '#16C0D0', '#C62100', '#014347', '#233809', '#42083B', '#82785D', '#023087', '#196956', '#8C41BB', '#2B2D32', '#94C661', '#F8907D', '#895E6B', '#788E95', '#FB6AB8', '#576094', '#DB1474', '#8489AE', '#860E04',
            '#FBC206', '#6EAB9B', '#645341', '#760035', '#647A41', '#496E76', '#876128', '#A1A711', '#01FB92', '#FD0F31', '#BE8485', '#C660FB', '#120104', '#D48958', '#05AEE8', '#C3C1BE', '#9F98F8', '#1167D9', '#D19012', '#B7D802', '#826392', '#5E7A6A', '#B29869', '#1D0051', '#76E0C1', '#BACFA7', '#11BA09', '#462C36', '#65407D', '#491803', '#03422C', '#72A46E', '#128EAC', '#47545E', '#B95C69', '#A14D12', '#372A55', '#3F3610', '#D3A2C6', '#719FFA', '#0D841A', '#4C5B32', '#9DB3B7', '#B14F8F', '#747103', '#9F816D', '#D26A5B', '#8B934B', '#F98500', '#002935',
            '#FCB899', '#1C0720', '#6B5F61', '#F98A9D', '#9B72C2', '#A6919D', '#2C3729', '#D7C70B', '#9F9992', '#923A52', '#5140A7', '#BC14FD', '#6D706C', '#0007C4', '#C6A62F', '#000C14', '#904431', '#600013', '#1C1B08', '#693955', '#5E7C99', '#6C6E82', '#D0AFB3', '#493B36', '#AC93CE', '#C4BA9C', '#09C4B8', '#69A5B8', '#374869', '#F868ED', '#E70850', '#C04841', '#C36333', '#700366', '#8A7A93', '#52351D', '#B503A2', '#D17190', '#A0F086', '#7B41FC', '#0EA64F', '#017499', '#08A882', '#7300CD', '#A9B074', '#4E6301', '#AB7E41', '#547FF4', '#134DAC', '#056164',
            '#FE12A0', '#C264BA', '#939DAD', '#0BCDFA', '#277442', '#1BDE4A', '#826958', '#977678', '#7D8475', '#8CCF95', '#726638', '#6B9279', '#C2FE4B', '#304041', '#1EA6A7', '#022403', '#062A47', '#054B17', '#F4C673', '#02FEC7', '#9DBAA8', '#775551', '#835536', '#565BCC', '#80D7D2', '#7AD607', '#696F54', '#87089A', '#664B19', '#242235', '#7DB00D', '#D5A97E', '#433F31', '#311A18', '#D586C9', '#7A5FB1', '#32544A', '#859D96', '#2B8570', '#8B282D', '#E16A07', '#4B0125', '#021083', '#114558', '#F707F9', '#C78571', '#7FB9BC', '#FC7F4B', '#8D4A92', '#6B3119',
            '#884F74', '#994E4F', '#9DA9D3', '#867B40', '#1CA2FE', '#D9C5B4', '#FEAA00', '#507B01', '#A7D0DB', '#53858D', '#588F4A', '#FC93C1', '#3E4A02', '#7A8B62', '#9A5AE2', '#896C04', '#B1121C', '#402D7D', '#858701', '#D498A6', '#B484EF', '#5C474C', '#067881', '#726075', '#8D3101', '#6C93B2', '#A26B3F', '#AA6582', '#4F4C4F', '#5A563D', '#E83005', '#32492D', '#FC7272', '#B9C457', '#552A5B', '#B50464', '#616E79', '#CF8028', '#0AE2F0', '#4F1E24', '#FD5E46', '#4B694E', '#5DC262', '#022D26', '#7776B8', '#FD9F66', '#B049B8', '#988F73', '#BE385A', '#2B2126',
            '#54805A', '#141B55', '#67C09B', '#456989', '#166175', '#C1E29C', '#A397B5', '#2E2922', '#ABDBBE', '#B4A6A8', '#A06B07', '#A99949', '#0A0618', '#B14E2E', '#60557D', '#D4A556', '#82A752', '#4A005B', '#3C404F', '#6E6657', '#7E8BD5', '#1275B8', '#D79E92', '#230735', '#661849', '#7A8391', '#FE0F7B', '#B0B6A9', '#629591', '#D05591', '#97B68A', '#97939A', '#035E38', '#53E19E', '#02436C', '#525A72', '#059A0E', '#3E736C', '#AC8E87', '#D10C92', '#B9906E', '#66BDFD', '#0734BC', '#341224', '#8AAAC1', '#0E0B03', '#414522', '#6A2F3E', '#2D9A8A', '#4568FD',
            '#FEE007', '#9A003C', '#AC8190', '#DCDD58', '#B7903D', '#1F2927', '#9B02E6', '#827A71', '#878B8A', '#8F724F', '#AC4B70', '#37233B', '#385559', '#F347C7', '#9DB4FE', '#D57179', '#DE505A', '#37F7DD', '#503500', '#1C2401', '#DD0323', '#00A4BA', '#955602', '#FA5B94', '#AA766C', '#B8E067', '#6A807E', '#4D2E27', '#73BED7', '#D7BC8A', '#614539', '#526861', '#716D96', '#829A17', '#210109', '#436C2D', '#784955', '#987BAB', '#8F0152', '#0452FA', '#B67757', '#A1659F', '#48416F', '#DEBAAF', '#A5A9AA', '#8C6B83', '#403740', '#70872B', '#D9744D', '#151E2C',
