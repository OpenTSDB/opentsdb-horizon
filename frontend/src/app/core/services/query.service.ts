...
export class QueryService {
    ...
    buildQuery(widget, time, query, options: any = {}) {
        ...
        const summary = widget.settings.component_type === 'LinechartWidgetComponent' || widget.settings.component_type === 'TableWidgetComponent' 
                                  || widget.settings.component_type === 'HeatmapWidgetComponent' ? false : true;
