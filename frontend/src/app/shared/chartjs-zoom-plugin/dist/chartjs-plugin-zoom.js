            ...
            function (require, module, exports) {
                ...
                module.exports = function (Chart) {
                    ...
                    function initialize(chart) {
                        zoomOptions = chartHelpers.configMerge(
                            Chart.Zoom.defaults,
                            chart.options.zoom
                        );
                    ...
                    function clear(chart) {
                        ...
                        ctx.clearRect(
                            0,
                            0,
                            chart.zoom.newLayer.width,
                            chart.zoom.newLayer.height
                        );
                    }
                    ...
                    return {
                        ...
                        afterInit: function (chart) {
                            ...
                            if (zoomOptions.enabled) {
                                ...
                                chartHelpers.each(
                                    chart.scales,
                                    function (scale) {
                                        scale.originalOptions = JSON.parse(
                                            JSON.stringify(scale.options)
                                        );
                                    }
                                );
                                ...
                                chart.zoom._mouseDownHandler = function (e) {
                                    if (e.type == "mousedown") {
                                        if (
                                            inRange(e.offsetX, e.offsetY, chart)
                                        ) {
                                            ...
                                            chartHelpers.addEvent(
                                                document,
                                                "mousemove",
                                                chart.zoom._mouseMoveHandler
                                            );
                                            chartHelpers.addEvent(
                                                document,
                                                "mouseup",
                                                chart.zoom._mouseUpHandler
                                            );
                                        }
                                    }
                                };
                                ...
                                chart.zoom._doubleClickHandler = function (e) {
                                    dragging = false;
                                    chart.zoom.newLayer.style.visibility =
                                        "hidden";
                                    chart.resetZoom();
                                };
                                ...
                                chart.zoom._mouseUpHandler = function (e) {
                                    dragEndX =
                                        e.offsetX - chart.ctx.canvas.offsetLeft;
                                    dragEndY =
                                        e.offsetY - chart.ctx.canvas.offsetTop;
                                ...
                                chart.zoom._mouseMoveHandler = function (e) {
                                    ...
                                    if (dragging) {
                                        var offsetX =
                                            e.offsetX -
                                            chart.ctx.canvas.offsetLeft;
                                        var offsetY =
                                            e.offsetY -
                                            chart.ctx.canvas.offsetTop;
                                        var xDelta = Math.abs(
                                            offsetX - dragStartX
                                        );
                                        var yDelta = Math.abs(
                                        ...
                                        if (inRange(offsetX, offsetY, chart)) {
                                            ...
                                            draw(
                                                chart,
                                                x + chart.ctx.canvas.offsetLeft,
                                                y + chart.ctx.canvas.offsetTop,
                                                w,
                                                h,
                                                chart.ctx
                                            );
                                ...
                                chartHelpers.addEvent(
                                    chart.ctx.canvas,
                                    "mousedown",
                                    chart.zoom._mouseDownHandler
                                );
                                chart.ctx.canvas.addEventListener(
                                    "selectstart",
                                    function (e) {
                                        e.preventDefault();
                                        return false;
                                ...
                                chartHelpers.addEvent(
                                    chart.ctx.canvas,
                                    "dblclick",
                                    chart.zoom._doubleClickHandler
                                );
                            }
                        },
                        ...
                        destroy: function (chart) {
                            if (zoomOptions.enabled) {
                                ...
                                chart.ctx.canvas.removeEventListener(
                                    "selectstart",
                                    chart.zoom._selectStartHandler
                                );
                                delete chart.zoom;
                            }
                        },
