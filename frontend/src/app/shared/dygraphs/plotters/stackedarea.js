...
var utils = require("dygraphs/src/dygraph-utils");
  ...
  DygraphLayoutCalcYNormal_ = function(axis, value, logscale) {
    if (logscale) {
 ...
 */
DygraphCanvasRendererGetIteratorPredicate = function(connectSeparatedPoints) {
 ...
 * @private
 */
DygraphCanvasRendererDrawStyledLine = function(e,
...
DygraphCanvasRendererDrawPointsOnLine = function(
    e, pointsOnLine, drawPointCallback, color, pointSize) {
  var ctx = e.drawingContext;
...
DygraphCanvasRendererDrawSeries = function(e,
...
DygraphCanvasRendererFastCanvasProxy_ = function(context) {
