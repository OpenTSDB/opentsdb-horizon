...
var DygraphCanvasRendererDrawSeries = function (
    ...
    for (var i = iter.start_; i < limit; i++) {
        ...
        // FIXME: The 'canvasy != canvasy' test here catches NaN values
        // but the test doesn't catch Infinity values.
        // Could change this to !isFinite(point.canvasy), but I assume
        // it avoids isNaN for performance?
