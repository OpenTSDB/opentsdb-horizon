...
module.exports = function (Chart) {
    ...
    function updateConfig(chart) {
        ...
        lineConfig =
            chart.options.threshold && chart.options.threshold.line
        ...
        chart.threshold.overlayCanvas.style.display = chart.options.threshold
            .draw
            ? "block"
            : "none";
    ...
    function draw(chart) {
        var ctx =
            chart.options.threshold && chart.options.threshold.draw
            ...
            chart.threshold._mouseDownEventHandler = function (e) {
                ...
                if (chart.options.threshold.draw) {
                    if (chart.threshold.selection) {
                        ...
                        Object.keys(chart.threshold.elements).length <
                        ...
                        chart.threshold.elements[id] = new ThresholdLine(
                            chart,
                            chartHelpers.configMerge(
                                Chart.Threshold.lineDefaults,
                                options
            ...
            chart.threshold._mouseMoveEventHandler = function (e) {
                if (dragging) {
                    if (
                        ...
                        chart.threshold.selection.value = chart.scales[
                            chart.threshold.selection.scaleId
                        ].getValueForPixel(e.offsetY);
            ...
            if (
                ...
                for (var i = 0, len = thresholds.length; i < len; i++) {
                    ...
                    if (!chart.threshold.elements[id]) {
                        ...
                        chart.threshold.elements[id] = new ThresholdLine(
                            chart,
                            chartHelpers.configMerge(lineConfig, thresholds[i])
                        );
                    } else {
                        chart.threshold.elements[id] = new ThresholdLine(
                            chart,
